            ...
            >
              ...
              <div className="p-6">
                ...
                {(res.status === 'pending' || res.status === 'reserved') && (
                  <Link to={`/verify/${res.id}`}>
                    <button className="w-full bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-bold py-3 rounded-xl flex justify-center items-center space-x-2 transition-colors shadow-[0_0_15px_rgba(16,185,129,0.3)]">
